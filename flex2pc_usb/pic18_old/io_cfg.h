...
//utile per switch tra bootloader e comunicazione
/*
#define tris_PROG_SWITCH    TRISBbits.TRISB5    // RB5 Input (Weak Pull-up)
#define PROG_SWITCH_pin     PORTBbits.RB5
*/
#define tris_PROG_SWITCH    TRISBbits.TRISB4    // RB5 Input (Weak Pull-up)
#define PROG_SWITCH_pin     PORTBbits.RB4

#define tris_BUSY_LED       TRISBbits.TRISB5    // RC0 Output
#define BUSY_LED            LATBbits.LATB5
                            // RB6 is ICSPCLK (PGC)
    ...
    // Port C
    // ------
//da commentare il led di sistema è su RB5
/*
