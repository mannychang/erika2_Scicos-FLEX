  ...
  while %t do
    ...
    [ok, eventsin, eventsout, simmode, indata, outdata, engine_file, lab] = getvalue(dialog_box_banner,...
     ['Number of input event ports';'Number of output event ports';'Mode (1:interactive, 2:background)';...
      'Input Description ([type size;type size;...] ''type'' is 1 for real, 3 for int32, 4 for int16, ...)';...
      'Output Description ([type size;type size;...] ''type'' is 1 for real, 3 for int32, 4 for int16, ...)';'SMCube File'],...
