function [x,y,typ] = FLEX_DMB_LedsLcdBuz(job,arg1,arg2)
...
case 'set' then //** set parameters
  ...
  while %t do
    ...
    it = [input_leds_type;input_leds_type;input_leds_type;input_leds_type;...
          ...
          input_lcd_type(1);input_lcd_type(2);input_buz_type];
    o = [];
    ot = [];
...
case 'define' then      //** the standard define  
  ...
  flex_block_type_ledslcdb = 2;
  block_type = flex_block_type_ledslcdb;
  block_id = 0;
  ...
  gr_i=['[x,y,typ]=standard_inputs(o) ';
	...
	'xstring(orig(1)+dd,y(11)-r(4)/2,''BUZZER'')'
