...
{
	// to do: figure initialization to display the leds of the board.
}

static void inout(scicos_block *block)
{
	// to do: led status update in the figure.
}
...
FLEXSIM_LIB_API void flex_led(scicos_block *block,int flag)
{
